...
module top ;
          ...
          wire [5:0] Net_1058;
          wire [5:0] Net_1057;
          wire [5:0] DB_31_36_out;
          wire [5:0] Net_1056;
          wire [7:0] Net_1053;
          wire  Net_1040;
          wire  Net_1027;
          wire  Net_1026;
          wire [5:0] DB_37_42_out;
          wire [5:0] Net_1063;
          wire [5:0] Net_1062;
          wire [5:0] Net_1061;
          wire [7:0] Net_1065;
	...
	wire [7:0] tmpOE__Button_1_8_P0_net;
	wire [7:0] tmpIO_7__Button_1_8_P0_net;
	wire [0:0] tmpINTERRUPT_0__Button_1_8_P0_net;
	electrical [0:0] tmpSIOVREF__Button_1_8_P0_net;
	...
	cy_psoc3_pins_v1_10
		...
		Button_1_8_P0
		 (.oe(tmpOE__Button_1_8_P0_net),
		  .y({8'b0}),
		  .fb({Net_910[7:0]}),
		  .io({tmpIO_7__Button_1_8_P0_net[7:0]}),
		  .siovref(tmpSIOVREF__Button_1_8_P0_net),
		  .interrupt({tmpINTERRUPT_0__Button_1_8_P0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_1_8_P0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};

	wire [7:0] tmpOE__Button_9_16_P2_net;
	wire [7:0] tmpIO_7__Button_9_16_P2_net;
	wire [0:0] tmpINTERRUPT_0__Button_9_16_P2_net;
	electrical [0:0] tmpSIOVREF__Button_9_16_P2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d3a7879f-a2fd-4e31-87c3-7d085eb68331"),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		Button_9_16_P2
		 (.oe(tmpOE__Button_9_16_P2_net),
		  .y({8'b0}),
		  .fb({Net_940[7:0]}),
		  .io({tmpIO_7__Button_9_16_P2_net[7:0]}),
		  .siovref(tmpSIOVREF__Button_9_16_P2_net),
		  .interrupt({tmpINTERRUPT_0__Button_9_16_P2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_9_16_P2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
	...
	wire [7:0] tmpOE__Button_17_24_P3_net;
	wire [7:0] tmpIO_7__Button_17_24_P3_net;
	wire [0:0] tmpINTERRUPT_0__Button_17_24_P3_net;
	electrical [0:0] tmpSIOVREF__Button_17_24_P3_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("12333173-1e13-41ab-b355-afde879898ed"),
		  ...
		  .input_buffer_sel(16'b00_00_00_00_00_00_00_00))
		Button_17_24_P3
		 (.oe(tmpOE__Button_17_24_P3_net),
		  .y({8'b0}),
		  .fb({Net_946[7:0]}),
		  .io({tmpIO_7__Button_17_24_P3_net[7:0]}),
		  .siovref(tmpSIOVREF__Button_17_24_P3_net),
		  .interrupt({tmpINTERRUPT_0__Button_17_24_P3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_17_24_P3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
    ...
    defparam Debouncer_3.SignalWidth = 8;
    ...
    defparam ButtonReg3.NumInputs = 8;

    Debouncer_v1_0 DB_37_42 (
        .d(Net_1068[5:0]),
        .clock(InClk),
        .q(DB_37_42_out[5:0]),
        .neg(Net_1069[5:0]),
        .either(Net_1070[5:0]),
        .pos(Net_1071[5:0]));
    defparam DB_37_42.EitherEdgeDetect = 0;
    defparam DB_37_42.NegEdgeDetect = 0;
    defparam DB_37_42.PosEdgeDetect = 0;
    defparam DB_37_42.SignalWidth = 6;

	wire [5:0] tmpOE__Button_31_36_P12_net;
	wire [5:0] tmpIO_5__Button_31_36_P12_net;
	wire [0:0] tmpINTERRUPT_0__Button_31_36_P12_net;
	electrical [0:0] tmpSIOVREF__Button_31_36_P12_net;
	...
	cy_psoc3_pins_v1_10
		...
		Button_31_36_P12
		 (.oe(tmpOE__Button_31_36_P12_net),
		  .y({6'b0}),
		  .fb({Net_1060[5:0]}),
		  .io({tmpIO_5__Button_31_36_P12_net[5:0]}),
		  .siovref(tmpSIOVREF__Button_31_36_P12_net),
		  .interrupt({tmpINTERRUPT_0__Button_31_36_P12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_31_36_P12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

	wire [5:0] tmpOE__Button_37_42_P15_net;
	wire [5:0] tmpIO_5__Button_37_42_P15_net;
	wire [0:0] tmpINTERRUPT_0__Button_37_42_P15_net;
	electrical [0:0] tmpSIOVREF__Button_37_42_P15_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3176a361-b62e-4d2f-854d-2ec017a15a7b"),
		  ...
		  .input_buffer_sel(12'b00_00_00_00_00_00))
		Button_37_42_P15
		 (.oe(tmpOE__Button_37_42_P15_net),
		  .y({6'b0}),
		  .fb({Net_1068[5:0]}),
		  .io({tmpIO_5__Button_37_42_P15_net[5:0]}),
		  .siovref(tmpSIOVREF__Button_37_42_P15_net),
		  .interrupt({tmpINTERRUPT_0__Button_37_42_P15_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_37_42_P15_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

    CyStatusReg_v1_90 ButtonReg6 (
        .status_0(DB_37_42_out[4]),
        .status_1(DB_37_42_out[5]),
        .status_2(1'b0),
        .status_3(1'b0),
        .clock(InClk),
        .status_4(1'b0),
        ...
        .intr(Net_1066),
        .status_bus(8'b0));
    defparam ButtonReg6.Bit0Mode = 0;
    defparam ButtonReg6.Bit1Mode = 0;
    defparam ButtonReg6.Bit2Mode = 0;
    defparam ButtonReg6.Bit3Mode = 0;
    defparam ButtonReg6.Bit4Mode = 0;
    defparam ButtonReg6.Bit5Mode = 0;
    defparam ButtonReg6.Bit6Mode = 0;
    defparam ButtonReg6.Bit7Mode = 0;
    defparam ButtonReg6.BusDisplay = 0;
    defparam ButtonReg6.Interrupt = 0;
    defparam ButtonReg6.MaskValue = 0;
    defparam ButtonReg6.NumInputs = 2;

    CyStatusReg_v1_90 ButtonReg5 (
        .status_0(DB_31_36_out[2]),
        .status_1(DB_31_36_out[3]),
        .status_2(DB_31_36_out[4]),
        .status_3(DB_31_36_out[5]),
        .clock(InClk),
        .status_4(DB_37_42_out[0]),
        .status_5(DB_37_42_out[1]),
        .status_6(DB_37_42_out[2]),
        .status_7(DB_37_42_out[3]),
        .intr(Net_1064),
        .status_bus(8'b0));
    defparam ButtonReg5.Bit0Mode = 0;
    defparam ButtonReg5.Bit1Mode = 0;
    defparam ButtonReg5.Bit2Mode = 0;
    defparam ButtonReg5.Bit3Mode = 0;
    defparam ButtonReg5.Bit4Mode = 0;
    defparam ButtonReg5.Bit5Mode = 0;
    defparam ButtonReg5.Bit6Mode = 0;
    defparam ButtonReg5.Bit7Mode = 0;
    defparam ButtonReg5.BusDisplay = 0;
    defparam ButtonReg5.Interrupt = 0;
    defparam ButtonReg5.MaskValue = 0;
    defparam ButtonReg5.NumInputs = 8;

    Debouncer_v1_0 DB_31_36 (
        .d(Net_1060[5:0]),
        .clock(InClk),
        .q(DB_31_36_out[5:0]),
        .neg(Net_1061[5:0]),
        .either(Net_1062[5:0]),
        .pos(Net_1063[5:0]));
    defparam DB_31_36.EitherEdgeDetect = 0;
    defparam DB_31_36.NegEdgeDetect = 0;
    defparam DB_31_36.PosEdgeDetect = 0;
    defparam DB_31_36.SignalWidth = 6;

	wire [5:0] tmpOE__Button_25_30_P1_net;
	wire [5:0] tmpIO_5__Button_25_30_P1_net;
	wire [0:0] tmpINTERRUPT_0__Button_25_30_P1_net;
	electrical [0:0] tmpSIOVREF__Button_25_30_P1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6d43b738-b496-4522-b577-7154bede2b7a"),
		  ...
		  .input_buffer_sel(12'b00_00_00_00_00_00))
		Button_25_30_P1
		 (.oe(tmpOE__Button_25_30_P1_net),
		  .y({6'b0}),
		  .fb({Net_1031[5:0]}),
		  .io({tmpIO_5__Button_25_30_P1_net[5:0]}),
		  .siovref(tmpSIOVREF__Button_25_30_P1_net),
		  .interrupt({tmpINTERRUPT_0__Button_25_30_P1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Button_25_30_P1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{6'b111111} : {6'b111111};

    CyStatusReg_v1_90 ButtonReg4 (
        .status_0(DB_25_30_out[0]),
        .status_1(DB_25_30_out[1]),
        .status_2(DB_25_30_out[2]),
        .status_3(DB_25_30_out[3]),
        .clock(InClk),
        .status_4(DB_25_30_out[4]),
        .status_5(DB_25_30_out[5]),
        .status_6(DB_31_36_out[0]),
        .status_7(DB_31_36_out[1]),
        .intr(Net_1040),
        .status_bus(8'b0));
    defparam ButtonReg4.Bit0Mode = 0;
    defparam ButtonReg4.Bit1Mode = 0;
    defparam ButtonReg4.Bit2Mode = 0;
    defparam ButtonReg4.Bit3Mode = 0;
    defparam ButtonReg4.Bit4Mode = 0;
    defparam ButtonReg4.Bit5Mode = 0;
    defparam ButtonReg4.Bit6Mode = 0;
    defparam ButtonReg4.Bit7Mode = 0;
    defparam ButtonReg4.BusDisplay = 0;
    defparam ButtonReg4.Interrupt = 0;
    defparam ButtonReg4.MaskValue = 0;
    defparam ButtonReg4.NumInputs = 8;

    Debouncer_v1_0 DB_25_30 (
        .d(Net_1031[5:0]),
        .clock(InClk),
        .q(DB_25_30_out[5:0]),
        .neg(Net_1056[5:0]),
        .either(Net_1057[5:0]),
        .pos(Net_1058[5:0]));
    defparam DB_25_30.EitherEdgeDetect = 0;
    defparam DB_25_30.NegEdgeDetect = 0;
    defparam DB_25_30.PosEdgeDetect = 0;
    defparam DB_25_30.SignalWidth = 6;
